<?php $__env->startSection('body'); ?>
    ...
    <div class="banner1">
        <div class="container">
            <h3><a href="<?php echo e('/'); ?>">Home</a> / <span>Single</span></h3>
        </div>
    </div>
    <!--banner-->
    <!--content-->
                        ...
                        <div clas="single-top">
                            <div class="single-left">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li data-thumb="<?php echo e(asset($product->product_image)); ?>">
                                            <div class="thumb-image"> <img src="<?php echo e(asset($product->product_image)); ?>" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                                        <li data-thumb="<?php echo e(asset($product->product_image)); ?>">
                                            <div class="thumb-image"> <img src="<?php echo e(asset($product->product_image)); ?>" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">BDT.<?php echo e($product->product_price); ?></p>
                                <div class="description">
                                    <p><span>Quick Overview : </span> <?php echo e($product->short_description); ?></p>
                                </div>
                        ...
                        <div class="col-md-4 product-grid">
                            <div id="owl-demo" class="owl-carousel">
                                ...
                                <div class="item">
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.php"><img class="img-responsive " src="<?php echo e(asset('/')); ?>/front-end/images/r4.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.php">Lorem ipsum dolor </a></h6>
                                            <div class="block">
                                    ...
                                    <div class="recent-grids">
                                        <div class="recent-left">
                                            <a href="single.php"><img class="img-responsive " src="<?php echo e(asset('/')); ?>/front-end/images/r5.jpg" alt=""></a>
                                        </div>
                                        <div class="recent-right">
                                            <h6 class="best2"><a href="single.php">Duis aute irure </a></h6>
                                            <div class="block">
