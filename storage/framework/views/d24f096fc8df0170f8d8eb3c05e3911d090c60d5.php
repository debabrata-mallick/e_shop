                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        <div  class="grid-arrival">
                                                            <figure>
                                                                <a href="<?php echo e(route('single-product', ['id'=>$categoryProduct->id])); ?>" class="new-gri">
                                                                    <div class="grid-img">
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="<?php echo e(route('single-product', ['id'=>$categoryProduct->id])); ?>"><?php echo e($categoryProduct->product_name); ?></a></h6>
                                                            <span class="size">XL / XXL / S </span>
                                                            <p ><em class="item_price"><?php echo e($categoryProduct->product_price); ?></em></p>
                                            ...
                                            <div class="product-tab1">
                                                ...
                                                <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="<?php echo e(route('single-product', ['id'=>$categoryProduct->id])); ?>"><?php echo e($categoryProduct->product_name); ?></a></h6>
                                                        <span class="size">XL / XXL / S </span>
                                                        <p><?php echo e($categoryProduct->short_description); ?></p>
                                                        <p ><em class="item_price"><?php echo e($categoryProduct->product_price); ?></em></p>
                                                        <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                    </div>
                                                </div>
